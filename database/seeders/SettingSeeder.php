...
class SettingSeeder extends Seeder
{
    ...
    private function defaults(): array
    {
        return [
            ...
            [
                'key' => 'chat.enabled_message_types',
                'value' => [
                    'text',
                    'image',
                    'video',
                ...
                'type' => Setting::TYPE_JSON,
                'group' => Setting::GROUP_CHAT,
                'is_public' => false,
                'is_locked' => false,
            ],
            [
                'key' => 'chat.attachment_message_types',
                'value' => [
                    'image',
                    'video',
                    'audio',
            ...
            [
                'key' => 'chat.video_mime_types',
                'value' => ['video/mp4', 'video/quicktime', 'video/x-msvideo', 'video/x-matroska', 'video/webm'],
                'type' => Setting::TYPE_JSON,
                'group' => Setting::GROUP_CHAT,
                'is_public' => false,
                'is_locked' => false,
            ...
            [
                'key' => 'chat.audio_extensions',
                'value' => ['mp3', 'wav', 'aac', 'm4a', 'flac'],
                'type' => Setting::TYPE_JSON,
                'group' => Setting::GROUP_CHAT,
                'is_public' => false,
                'is_locked' => false,
            ...
            [
                'key' => 'chat.audio_mime_types',
                'value' => ['audio/mpeg', 'audio/wav', 'audio/aac', 'audio/mp4', 'audio/flac'],
                'type' => Setting::TYPE_JSON,
                'group' => Setting::GROUP_CHAT,
                'is_public' => false,
                'is_locked' => false,
            ...
            [
                'key' => 'chat.voice_mime_types',
                'value' => ['audio/ogg', 'audio/opus', 'audio/webm', 'audio/mp4'],
                'type' => Setting::TYPE_JSON,
                'group' => Setting::GROUP_CHAT,
                'is_public' => false,
                'is_locked' => false,
            ...
            [
                'key' => 'chat.file_extensions',
                'value' => ['pdf', 'doc', 'docx', 'xls', 'xlsx', 'csv', 'txt', 'zip', 'rar', '7z', 'ppt', 'pptx'],
                'type' => Setting::TYPE_JSON,
                'group' => Setting::GROUP_CHAT,
                'is_public' => false,
                'is_locked' => false,
            ...
            [
                'key' => 'chat.max_message_body_length',
                'value' => 5000,
                'type' => Setting::TYPE_INTEGER,
                'group' => Setting::GROUP_CHAT,
                'is_public' => false,
            ...
            [
                'key' => 'chat.max_attachments_count',
                'value' => 10,
                'type' => Setting::TYPE_INTEGER,
                'group' => Setting::GROUP_CHAT,
                'is_public' => false,
